...
STARTMAP=${STARTMAP:-gm_construct}
WORKSHOP=${WORKSHOP:-0}
NAME=${NAME:-DockerServer}
PASSWORD=${PASSWORD:-}
MAIL=${MAIL:-no@mail.addit}
...
TRAITORPCT=${TRAITORPCT:-100}
TRAITORMAX=${TRAITORMAX:-1}
DETPCT=${DETPCT:-50}
DETMAX=${DETMAX:-1}
DETMIN=${DETMIN:-5}


echo "Docker Image by nasourso  https://github.com/nasourso"
echo "---"
echo ""
